...
class Projection(Layer):
    ...
    '''
'''
class DenseProjection_avarge(Layer):
    Transform from IndexSpace to VectorSpace
    ...
    def __init__(self, layer_name, 
                    ...
                    **kwargs):
        super(DenseProjection_avarge, self).__init__()
        self.layer_name=layer_name
        self.word_num=word_num
        ...
        self.homoionym=theano.shared(homoionym,allow_downcast=True)
        self.similiarity=theano.shared(similarity,allow_downcast=True)
    ...
    def fprop(self,state_blow,return_all=True):
        ...
        rval=self.W[inputs]
        rval2=self.W[self.homoionym[inputs]]*self.similarity[inputs].dinshuffle(0,1,2,'x').mean(dim=2)
        rval=(rval+rval2)/2
